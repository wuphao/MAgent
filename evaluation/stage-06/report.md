...
- 报告ID：report_059b1441ce59fa7748f3
- Run ID：run_e3859f29bf5b7f78eea2
- 项目：stage06_eval
...
- **finding_275076036f39bfc2d6d6_reviewed**（unresolved，引用数 6）：XX-v1 total remains disputed: recomputed total 4 differs from source reported total 0; no source amendment is available in this run.
